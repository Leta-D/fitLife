...
Widget floatingBottomNavigation(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        border: Border.fromBorderSide(
          BorderSide(width: 1, color: mainGreenGenerator(0.6)),
        ),
        ...
        children: [
          for (var item in iconsMap.keys)
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    (iconsMap.keys.toList().indexOf(item) ==
                            appProvider.currentBottomNavIndex)
                        ? mainGreenGenerator(0.6)
                        : Colors.transparent,
              ...
              child: Row(
                children: [
                  IconButton(
                    onPressed: () {
                      appProvider.change_currentBottomNavIndex(
                        iconsMap.keys.toList().indexOf(item),
                      );
                    },
                    icon: iconsMap[item]!,
